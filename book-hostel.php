...
$query="insert into  registration(roomtype,seater,feespm,foodstatus,stayfrom,duration,course,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiiisisissssisississsisssi',$roomtype,$seater,$feespm,$foodstatus,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
$stmt->execute();
						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-primary">
									<div class="panel-heading">Fill all Info</div><br>
...
<div class="form-group">
<label class="col-sm-2 control-label">Room no. and Type</label>
<div>
&nbsp;&nbsp;&nbsp;   1. AC Room For One Person &nbsp;&nbsp;&nbsp;  4. Non-AC Room For One Person <br>
&nbsp;&nbsp;&nbsp;   2. AC Room For Two Person &nbsp;&nbsp;&nbsp;  5. Non-AC Room For Two Person <br>
&nbsp;&nbsp;&nbsp;   3. AC Room For Four Person &nbsp;&nbsp;&nbsp; 6. Non-AC Room For Four Person <br><br>
